...
class TestThermacellLivAPI:
    ...
    async def test_authenticate_success(self, api_client):
        ...
        mock_response.json.return_value = {"accesstoken": "test_token", "idtoken": mock_id_token}
        ...
        assert call_args[1]["json"] == {"user_name": "test_user", "password": "test_pass"}
    ...
    async def test_make_request_token_expired(self, api_client):
        ...
        responses = [AsyncMock(status=401), AsyncMock(status=200, content_type="application/json")]
    ...
    async def test_make_request_timeout_retry(self, api_client):
        ...
        side_effects = [TimeoutError(), TimeoutError(), mock_response]
    ...
    async def test_make_request_max_retries(self, api_client):
        ...
        api_client.session.request.side_effect = TimeoutError()
    ...
    async def test_set_node_params(self, api_client):
        ...
        with patch.object(api_client, "_make_request") as mock_request:
            ...
            mock_request.assert_called_once_with("PUT", "/user/nodes/params?nodeid=node123", params)
            assert result is True
    ...
    async def test_set_device_power(self, api_client):
        ...
        with patch.object(api_client, "set_node_params") as mock_set_params:
            ...
            mock_set_params.assert_called_once_with("node123", {"LIV Hub": {"Enable Repellers": True}})
            assert result is True
